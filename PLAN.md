...
| 0.6 | `arenaAllocator.h` | Para mejorar eficiencia creamos arena allocator y pedimos memoria ahi| ✅ | 
---
...
| # | Tarea | Descripción |
|---|-------|-------------|
| 1.1 | `Tensor` | Wrapper sobre `vector de floats (creado con Arena)` con shape, strides, slicing | ✅ |
| 1.2 | Operaciones | `matmul`, `add`, `softmax`, `RMSNorm`, `silu` | ✅ |
